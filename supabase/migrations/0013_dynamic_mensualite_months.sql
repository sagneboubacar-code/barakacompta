-- =========================================================================
-- generate_student_schedule() générait toujours les mensualités d'octobre à
-- juillet, quels que soient les "Mois de début/fin" configurés pour l'école
-- (Paramètres). Cette migration rend la séquence dynamique : les mensualités
-- courent du mois SUIVANT le mois de début jusqu'au mois SUIVANT le mois de
-- fin (le premier mois de l'année scolaire reste réservé à l'inscription),
-- en s'adaptant à n'importe quel mois de début choisi par l'école.
-- =========================================================================
...
begin
  ...
  -- sa fin, en bouclant sur l'année civile si besoin (ex. début=août ->
  -- 1ère mensualité en septembre).
